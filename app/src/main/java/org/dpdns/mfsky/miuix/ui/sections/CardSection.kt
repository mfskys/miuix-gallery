...
fun LazyListScope.cardSection(snackbarHostState: SnackbarHostState) {
    item(key = "card") {
        ...
        Row(
            ...
            Card(
                ...
                onClick = { scope.launch { snackbarHostState.showSnackbar("点击了 Sink 反馈的卡片") } },
                content = {
                    Text(
            ...
            Card(
                ...
                onLongPress = { scope.launch { snackbarHostState.showSnackbar("长按了 Tilt 反馈的卡片") } },
                content = {
                    Text(
                        color = MiuixTheme.colorScheme.onSurface,
                        text = "Card",
