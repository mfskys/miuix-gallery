...
private fun SuperBottomSheetDemo(
    ...
    OverlayBottomSheet(
        ...
        startAction = {
            BottomSheetActionButton(MiuixIcons.Close, "取消", onClick = onDismissRequest)
        },
        endAction = {
            BottomSheetActionButton(MiuixIcons.Ok, "确定", onClick = onDismissRequest)
        },
    ) {
        BottomSheetContent(
            allowDismiss = allowDismiss,
...
private fun WindowBottomSheetDemo(
    ...
    WindowBottomSheet(
        ...
        startAction = {
            ...
            BottomSheetActionButton(MiuixIcons.Close, "取消", onClick = { dismissState?.invoke() })
        },
        endAction = {
            val dismissState = LocalDismissState.current
            BottomSheetActionButton(MiuixIcons.Ok, "确定", onClick = { dismissState?.invoke() })
        },
    ) {
        BottomSheetContent(
            allowDismiss = allowDismiss,
